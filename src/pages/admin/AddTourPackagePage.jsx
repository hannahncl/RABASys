  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-cyan-500/30 bg-slate-900/70 p-6 shadow-2xl shadow-cyan-950/20">
        <div className="mb-6">
          <h1 className="text-2xl font-bold font-display text-slate-100">Add Tour Package</h1>
          <p className="text-sm text-slate-400">Fill in the details below to create a new tour package.</p>
        </div>
